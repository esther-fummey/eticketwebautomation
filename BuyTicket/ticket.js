...
async function navbarTest(browserName) {
  ...
  try {
    ...
    await eticket.wait(until.elementIsVisible(toppicks), 10000);
    ...
    await eticket.wait(until.elementIsVisible(dropdown), 10000);
    await dropdown.click();
    console.log("✅ Dropdown opened");

    // Step 2: Select the date
    const dateOption = await eticket.wait(
      until.elementLocated(By.xpath("//div[@class='list' and text()=' 2025-06-30 ']")),
      10000
    );
